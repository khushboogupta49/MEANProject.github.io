...
app.get("/",(req,res)=>{
    res.render("home" ,{ name:"MERN PROJECT",img:"/img/1.png"});
});


app.get("/about",(req,res)=>{
    res.render("about", {name:"KHUSHBOO KUMARI",img:"/img/2.png"});
});
...
app.get("/secret",auth,(req,res)=>{
    ...
    res.render("secret", {name:"KHUSHBOO KUMARI",img:"/img/download.jpg"});
});
